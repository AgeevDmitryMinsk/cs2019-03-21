...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String b="Как-то в полночь, в час угрюмый, утомившись от раздумий,\n"+"Задремал я над страницей фолианта одного,\n";
        String c="И очнулся вдруг от звука, будто кто-то вдруг застукал,\n" +
                "Будто глухо так затукал в двери дома моего.";
        String d="«Гость,— сказал я,— там стучится в двери дома моего," +
