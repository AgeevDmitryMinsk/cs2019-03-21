...
class TaskA2 {
    public static void main(String[] args) {
        ...
        String a = "У сердца с глазом - тайный договор:";
        String b = "Они друг другу облегчают муки,";
        String c = "Когда тебя напрасно ищет взор";
        String d = "И сердце задыхается в разлуке.";
