...
class TaskA2 {
    public static void main(String[] args) {
        String a="Кто я? Что я? Только лишь мечтатель,";
        String b="Перстень счастья ищущий во мгле,";
        String c="Эту жизнь живу я словно кстати,";
        String d="Заодно с другими на земле.";
